...
export const COMPLIANCE_LINE =
  'EXPERIMENTAL PEPTIDES SHOWN HERE ARE IN DEVELOPMENT AND NOT AVAILABLE FOR SALE · MOBILITY COLLAGEN IS A NUTRITIONAL SUPPLEMENT, NOT A VETERINARY MEDICINE · NO PET PEPTIDE PRODUCT IS FDA OR SAHPRA APPROVED · ALWAYS CONSULT YOUR VETERINARIAN';
